...
function All_Patients_View() {
    ...
    const completed = rows.filter(row => row.status === "Inactive").length; // Assuming Inactive as completed; adjust as needed
    const pending = rows.length - activeTreatments - completed;
