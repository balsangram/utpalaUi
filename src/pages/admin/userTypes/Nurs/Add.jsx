...
function Add_Nurs() {
  ...
  // Initial empty nurse data for creation
  ...
  const handleSave = async () => {
    ...
    if (!nurse.name || !nurse.email || !nurse.specialty || !nurse.licenseNumber) {
      alert("Please fill in the required fields (Name, Email, Specialty, License Number).");
      return;
    }
    ...
    console.log("Created Nurse Data:", nurse);
    setIsSaving(false);
    setShowSuccess(true);

    setTimeout(() => {
      setShowSuccess(false);
      navigate("/admin/nurses"); // Redirect to nurses list
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-bg-a)" }}>
      ...
      <HeadingCard
        ...
        title="Add New Nurse"
        subtitle="Create a new nurse profile with complete information"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-3">
              ...
              {/* Quick Preview Placeholder (for new nurse) */}
              <div
