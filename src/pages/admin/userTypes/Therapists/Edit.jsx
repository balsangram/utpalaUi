                        ...
                        <div className="sticky top-24 space-y-3">
                            ...
                            >
                                ...
                                <div className="space-y-2 text-sm">
                                    <p style={{ color: "var(--color-text)" }}>License: {therapist.licenseNumber}</p>
                                    <p style={{ color: "var(--color-text)" }}>Joined: {therapist.joiningDate}</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default Edit_Therapists;