...
function Add_Receptionists() {
  ...
  // Initial empty receptionist data for creation
  ...
  const handleSave = async () => {
    ...
    if (!receptionist.name || !receptionist.email || !receptionist.position || !receptionist.employeeId) {
      alert("Please fill in the required fields (Name, Email, Position, Employee ID).");
      return;
    }
    ...
    console.log("Created Receptionist Data:", receptionist);
    setIsSaving(false);
    setShowSuccess(true);

    setTimeout(() => {
      setShowSuccess(false);
      navigate("/admin/receptionists"); // Redirect to receptionists list
    }, 2000);
  };
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-bg-a)" }}>
      ...
      <HeadingCard
        ...
        subtitle="Create a new receptionist profile with complete information"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-3">
              ...
              {/* Quick Preview Placeholder (for new receptionist) */}
              <div
              ...
              >
                ...
                <div className="space-y-2 text-xs">
                  <p style={{ color: "var(--color-text)" }}>Employee ID: To be assigned</p>
...
export default Add_Receptionists;