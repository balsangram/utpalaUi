...
function Add_Patients() {
  ...
  const handleAddFamilyMember = () => {
    ...
    const newRelation = prompt("Enter relation (e.g., Spouse, Child):");
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-bg-a)" }}>
      ...
      <HeadingCard
        ...
        subtitle="Create a new patient profile with complete information"
      />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24 space-y-3">
              ...
              {/* Quick Preview Placeholder (for new patient) */}
              <div
              ...
              >
                ...
                <div className="space-y-2 text-xs">
                  <p style={{ color: "var(--color-text)" }}>Patient ID: To be assigned</p>
                  <p style={{ color: "var(--color-text)" }}>Blood Group: Required</p>
                </div>
              </div>
            </div>
          </div>
            ...
            >
              ...
              <div className="p-6 border-b" style={{ borderColor: "var(--color-text)" }}>
                ...
                <p className="text-sm mt-1" style={{ color: "var(--color-text)" }}>
                  Fill in the information below to create the new patient profile
                </p>
              </div>
