...
// // import { login } from "../../pages/auth/Login"; // Adjust path to your auth slice as needed
...
//                     // Dispatch login action with user, token, and role
//                     dispatch(login({
//                         user: result.user,
//                         token: result.token,
//                         role: result.user.role, // Assuming user object has a 'role' property
//                     }));
//                     console.log("🚀 ~ handleOtpSubmit ~ dispatch:", dispatch)

//                     // Role-based redirect
//                     const userRole = result.user.role?.toLowerCase();  // FIX

//                     console.log("🚀 ~ handleOtpSubmit ~ userRole:", userRole)
//                     if (userRole === "admin") {
